...
export const templateRegistry: TemplateDefinition[] = [
  {
    ...
    description:
      "Monthly visibility framework for family law firms with keyword pairing, competitor tracking, and GSC exclusion controls.",
    ...
    requiredKeywordFields: ["text", "keywordType", "market", "intentGroup"],
    defaultDashboards: [
      "executive_overview",
      "competitor_solv",
      "map_pack",
